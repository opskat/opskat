...
//
//	mockgen -destination=./internal/service/oss_svc/mock_ossclient/mock.go -package=mock_ossclient github.com/opskat/opskat/internal/service/oss_svc Client
//
...
func (m *MockClient) ListObjects(ctx context.Context, bucket, prefix string, maxKeys int, continuationToken string) (*oss_svc.ListObjectsPage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListObjects", ctx, bucket, prefix, maxKeys, continuationToken)
	ret0, _ := ret[0].(*oss_svc.ListObjectsPage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListObjects indicates an expected call of ListObjects.
func (mr *MockClientMockRecorder) ListObjects(ctx, bucket, prefix, maxKeys, continuationToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListObjects", reflect.TypeOf((*MockClient)(nil).ListObjects), ctx, bucket, prefix, maxKeys, continuationToken)
}
