		...
		&tool.RawTool{
			...
			SchemaVal: agent.Schema{
				...
				Properties: map[string]*agent.Property{
					...
					"type":              {Type: "string", Description: `Asset type: "ssh" (default), "serial", "rdp", "vnc", "database", "redis", "mongodb", "kafka", "k8s", or "etcd".`},
					...
					"port":              {Type: "number", Description: "Port number (default: 22 for SSH, 3389 for RDP, 5900 for VNC, 3306 for MySQL, 5432 for PostgreSQL, 6379 for Redis, 27017 for MongoDB, 9092 for Kafka, 2379 for etcd). Not used for serial / k8s; for kafka used only when brokers is omitted."},
