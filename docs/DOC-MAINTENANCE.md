...
| [`./references/windows-local-ipc.md`](./references/windows-local-ipc.md) | Windows IPC investigation evidence, transport security/lifecycle boundaries, standalone AF_UNIX probe and regression verification. |
