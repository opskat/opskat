...
import { DetectSkills, GetAppVersion, GetDataDir, GetOpsctlInstallDir, UninstallSkill } from "../../wailsjs/go/system/System";
...
describe("AISettingsSection", () => {
  ...
  it("uninstalls a single installed AI plugin target", async () => {
    vi.mocked(DetectSkills)
      .mockResolvedValueOnce([{ key: "codex", name: "Codex", installed: true, path: "C:/Users/test/.codex/skills/opsctl" }])
      .mockResolvedValueOnce([{ key: "codex", name: "Codex", installed: false, path: "C:/Users/test/.codex/skills/opsctl" }]);
